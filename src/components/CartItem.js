...
import { deleteItem, resetCart } from '../redux/DarkSlice';
import { toast } from 'react-toastify';
import {Link} from "react-router-dom";
import { incrementQuantity } from '../redux/DarkSlice';
import { decrementQuantity } from '../redux/DarkSlice';
  ...
  return (
    <div className='w-2/3 pr-10'>
      ...
      <div>
        ...
        <button 
          onClick={() =>
          dispatch(resetCart()) & alert("Your Cart is Empty!")
        }
